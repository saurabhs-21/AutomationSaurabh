package com.uiFramework.smart24x7.rosterUpload.helper.wait;
...
public class WaitHelper {
	...
	/**
	 * This will help us to get DriverWait object
	 * 
	...
	/**
	 * This method give us fluentWait object
	 * 
	 * @param timeOutInSeconds
	 * @param pollingEveryInMiliSec
	 * @return
	...
	public WebElement waitForElement(WebElement element, int timeOutInSeconds, int pollingEveryInMiliSec) {
		...
		fwait.until(ExpectedConditions.visibilityOfAllElements(element));
		return element;
	}
